...
This is the authoritative status for the unreleased 0.61.0 working tree. A
...
| R10 Exact-SHA evidence | Integrated | `scripts/generate-certification-manifest.py` | clean artifact conformance | `Clean release qualification` |  | GitHub reports no runs for `release-qualification.yml`; no fresh-checkout exact-SHA artifact exists. |
