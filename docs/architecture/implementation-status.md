...
| R3 Production security | Scaffolded | `crates/mongreldb-core/src/security_hardening.rs` | module unit tests | workspace tests |  | No production SCRAM exchange, OIDC/JWKS verifier, KMS integration, or crash-safe online rotation. |
